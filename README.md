![docker image](https://github.com/Automate-Solar/Uppsala-s-NOMAD-Oasis/actions/workflows/docker-publish.yml/badge.svg)

# Automate-Solar's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of Automate-Solar.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Automate-Solar/Uppsala-s-NOMAD-Oasis.git
    cd Uppsala-s-NOMAD-Oasis
    ```

    or

    ```sh
    curl -L -o Uppsala-s-NOMAD-Oasis.zip "https://github.com/Automate-Solar/Uppsala-s-NOMAD-Oasis/archive/main.zip"
    unzip Uppsala-s-NOMAD-Oasis.zip
    cd Uppsala-s-NOMAD-Oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/automate-solar/uppsala-s-nomad-oasis:main` for the services
...
```sh
docker pull ghcr.io/automate-solar/uppsala-s-nomad-oasis/jupyter:main
```
...
- _I get an_ `Error response from daemon: Head "https://ghcr.io/v2/automate-solar/uppsala-s-nomad-oasis/manifests/main": unauthorized` _when trying to pull my docker image._
